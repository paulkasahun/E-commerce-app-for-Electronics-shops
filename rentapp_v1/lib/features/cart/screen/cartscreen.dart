...
import 'package:rentapp_v1/features/cart/widget/cart_product.dart';
import 'package:rentapp_v1/features/cart/widget/cart_subtotal.dart';
import 'package:rentapp_v1/features/home/widgets/addres_box.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomButton(
                ...
                text: 'Proceed to Rent(${user.cart.length} items)',
